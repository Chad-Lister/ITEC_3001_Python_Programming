...
This module defines the SavingsAccount and Bank classes.  Modified from book version.
...
class Bank(object):
    ...
    # Added by Chad.  Get a sorted list of PINS.
    def getPins(self):
        """ Returns a sorted list of PINS. """

        self._sortedPins = []
        
        for key in self._accounts:
            self._sortedPins.append(key)
            
        self._sortedPins.sort()
        
        return self._sortedPins
